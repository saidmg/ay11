<template>
  ...
  >
    ...
    <slot />
    <div class="bottom-container" style="display: flex; justify-content: flex-end">
      <div class="copy-container" style="display: flex">
        <span class="copied-text m-2 p-2" v-if="copied" style="color: white"
          >Copied code!</span
        >
        <button @click="copy(code)" class="m-2 p-2" style="color: white">
          Copy Code
        </button>
      </div>
    </div>
