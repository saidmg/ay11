<template>
  ...
  >
    ...
    <span class="block sm:inline"
      >Best practices dictate using the appropriate semantic HTML elements over ARIA roles to mark up lists and listitems — ul, ol and li. See Best practices for a full example.
      </span>
  </div>
    <p class="font-bold text-xl mb-2 text-gray-700 mt-5">Keep in mind:</p>
